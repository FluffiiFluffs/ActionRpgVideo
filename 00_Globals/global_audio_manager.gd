...
#func _ready() -> void:	
	...
	#for i in music_audio_player_count:
		#var _audioplayer = AudioStreamPlayer.new()
		#add_child(_audioplayer)
		#_audioplayer.bus = music_bus
		#music_players.append(_audioplayer)
	#
...
@export var max_volume :float= -15
var music_audio_player_count : int = 2
var current_music_player : int = 0
var music_players : Array[ AudioStreamPlayer ] = []
var music_bus : String = "Music"
...
func play_and_fade_in( player : AudioStreamPlayer ) -> void:
	player.play( 0 )
	var tween : Tween = create_tween()
	tween.tween_property( player, 'volume_db', max_volume, music_fade_duration )
	pass
